...
// fixed # of row: 999
inline void matrix_product (const int n, const double a[999][3], const double b[3][3], double c[999][3]) {
    for (int i = 0; i < n; i++) {
...
inline double matrix_det (const double a[3][3]) {
    return a[0][0] * a[1][1] * a[2][2] + a[0][1] * a[1][2] * a[2][0] + a[0][2] * a[1][0] * a[2][1]
         - a[2][0] * a[1][1] * a[0][2] + a[2][1] * a[1][2] * a[0][0] + a[2][2] * a[1][0] * a[0][1];
}

// Get the inverse of a 3x3 matrix
inline void matrix_inverse (const double a[3][3], double b[3][3]) {
